...
expName = 'Visual search main code'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\DELL\\OneDrive\\Desktop\\PsychoPy\\Visual Search Experiment\\Visual search main code.py',
