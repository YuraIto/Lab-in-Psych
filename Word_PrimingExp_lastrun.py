...
expName = 'Word_PrimingExp'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\DELL\\OneDrive\\Desktop\\PsychoPy\\5 Word Priming\\Word_PrimingExp_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    submit_text = visual.TextStim(win=win, name='submit_text',
        ...
        font='Arial',
        pos=(0, -0.3), draggable=True, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-2.0);
    ...
    for thisTrial_2 in trials_2:
        ...
        test = data.Routine(
            name='test',
            components=[TestText, test_textbox, submit_text, testmouse],
        )
