...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\DELL\\OneDrive\\Desktop\\PsychoPy\\Signal Detection\\SD_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text="Welcome to the Experiment!\n\nYou will be shown circular grids which are either straight vertical or tilted to some degree.\n\nIf the lines are straight vertical, press the 'Up' arrow key \nIf the lines are tilted, press the 'Down, arrow key\n\nPress 'Space' to Continue",
        font='Arial',
