...
expName = 'Intentional Binding Main File'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\DELL\\OneDrive\\Desktop\\PsychoPy\\7 Intentional Binding\\Intentional Binding Main File_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay between the keypress and the beep sound (on a 0-999 milliseconds scale).\nClick submit after entering the value.',
        font='Arial',
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('Intentional Binding Instruction file.xlsx'), 
        seed=None, 
    )
