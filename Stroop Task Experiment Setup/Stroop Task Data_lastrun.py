...
expName = 'Stroop Task Data'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\DELL\\OneDrive\\Desktop\\PsychoPy\\Stroop Task Data_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text="Welcome!\n\nWhen you see BLUE text, PRESS 'B'\nWhen you see RED text, PRESS 'R'\n\nDo not pay attention to what colour the text says and instead focus on what colour it is.\n\nPress *Space* to Continue",
        font='Arial',
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('C:/Users/DELL/Downloads/condition_stroop.xlsx'), 
        seed=None, 
    )
